...
CREATE TABLE orders (
    ...
    FOREIGN KEY (customerID) REFERENCES userid (id),
...
CREATE TABLE order_contents (
    ...
    productPrice decimal(8, 2) NOT NULL --PHP code needed to set this based on each order
    parentOrder int NOT NULL,
    FOREIGN KEY (parentOrder) REFERENCES orders (orderID)
);
