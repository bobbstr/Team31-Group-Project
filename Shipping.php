...
<div class="row">
    <form action="payment.php" method="POST">
        ...
        <div class="Shipping Address">
            ...
            <input class ="payInput" name="fname" placeholder="First name"></input>
            <input class ="payInput" name="lname" placeholder="Last name"></input><br>
            <input class ="payInput" name="company" placeholder="Company (optional)"></input><br>
            <input class ="payInput" name="address" placeholder="Address"><br>
            <input class ="payInput" name="apartment" placeholder="Apartment, suite, etc. (optional)"><br>
            <input class ="payInput" name="city" placeholder="City">
