...
<header>
    <div class="mbar">
        ...
        <div class="section">
            <p>
                <a href="search.php?q=sweets" class="filter_button" id="sweets">Sweets</a>
                ...
                <a href="search.php?q=" class="filter_button" id="all">All</a>
            </p>
        </div>
    </div>
</header>
...
<div class="contactform" action="">
          ...
          <p>Please fill this form completely if you want to enquire about an order or have a general question</p>
            <form action="">
              ...
              <input type="text" id="confirmemail" name=" confirmemail" placeholder="Confirm Email" required>
            ...
            <input type="checkbox" id="Phone-call" name="Phone-call" value="Phone ">
            ...
            <h4>When would you like to be contacted?</h4>
            <form action="">
              <label for="contact">Selected day:</label>
              <input type="date" id="contact" name="contact">
            </form>


            <h4>Why would you like to contact us?</h4>
            <textarea id="Enquire" name="Enquire" rows="4" cols="50">
            </textarea>
...
<center>
<h1> Find us at:</h1>
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2429.581261134505!2d-1.890822723951722!3d52.48671703869404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870bc9ae4f2e4b3%3A0x9a670ba18e08a084!2sAston%20University!5e0!3m2!1sen!2suk!4v1741130935431!5m2!1sen!2suk" width="1235" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</center>
...
<div class ="contactme">
       <h1>Other ways to get in touch:</h1>
        ...
        <p>Welcome to the contact us page of Sugar Rush here you can find helpful information on how you can reach us out </p>
        ...
        <p>Address: The Aston Triangle, Birmingham, West Midlands, B4 7ET.</p>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
          ...
          <p>Link to our Twitter - <a href="https://x.com/?lang=en-gb">SugarRush Twitter</a></p>
          <p>Twitter username - SugarRush</p>
          ...
          <p>Link to our Instagram - <a href="https://www.instagram.com/">SugarRush Instagram</a></p>
          <p>Instagram username - SugarRush</p>

          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
              <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
          </svg>
          <p>Our email is - contactus@sugarush.com</p>
          <a href="mailto:contactus@sugarush.com"> click here to send email</a>
